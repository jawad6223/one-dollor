...
Invalid Credentials 
   ...
   @endif
                        ...
                        <form class="theme-form" action="{{url('user/verification_action')}}" method="post">
                           @csrf
                           <h3 style="text-align:center">Verification</h3>
                           <p  style="text-align:center">You will get a otp via email</p>
                          
                           <div class="form-group">
                      <input   type="hidden"   name="user_id" value={{$id}} >

                              <div class="form-input position-relative">
                                 <input class="form-control" id="login_password" type="password" required  name="otp" placeholder="">
                                       @if (session('error'))
   ...
   @endif
                           ...
                           <div class="form-group mb-0">
                              ...
                              <div class="text-end mt-3">
                               ...
                               <p class="mt-4 mb-0">Didn't receive the verification OTP?<a class="ms-2" href="{{url('user/again_verification_action/' .$id)}}">Resend Again</a></p>
                           </div>
