...
<!-- Mirrored from artemsemkin.com/rhye/html/page-inner-about-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Nov 2020 14:28:29 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>About – 850TH Group</title>
    ...
    <link rel="preload" type="text/css" href="{{asset('public/assets1/css/vendor.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" type="text/css" href="{{asset('public/assets1/css/vendor.css')}}"></noscript>
    <!-- Template Main Stylesheet -->
    <link rel="preload" type="text/css" href="{{asset('public/assets1/css/main.css')}}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" type="text/css" href="{{asset('public/assets1/css/main.css')}}"></noscript>
    ...
    <meta name="theme-color" content="#ffffff">
      <link rel="icon" type="image/x-icon" href="{{asset('public/assets1/img/assets/projects/logo-w.png')}}">
  </head>
  <body>
      ...
      <div class="preloader text-center bg-dark-2" id="js-preloader" data-arts-theme-text="light">
        <div class="preloader__content">
          ...
          <div class="preloader__header mt-auto">
            <div class="preloader__heading h2"><img src="{{asset('public/assets1/img/assets/projects/logo.png')}}" style="height:100px;"></div>
            <div class="preloader__subline small-caps mt-1">850TH Group </div>
          </div>
          <!-- - header -->
          <!-- counter -->
          ...
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto header__col header__col-left"><a class="logo" href="index.php" >
                <div class="logo__wrapper-img">
                   <img class="logo__img-primary" src="{{asset('public/assets1/img/assets/projects/logo.png')}}" alt="850TH Group" style="height:50px;">
                  <img class="logo__img-secondary" src="{{asset('public/assets1/img/assets/projects/logo.png')}}" alt="850TH Group"  style="height:50px;">
                </div></a>
            </div>
            <!-- - logo -->
            <!-- burger icon -->
        ...
        <main class="page-wrapper__content">
                      ...
                      <div class="col">
                        <header class="section-masthead__header justify-content-center">
                          ...
                          <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                            <h1 class="h1 mt-0 mb-0">850TH Group</h1>
                          </div>
                        </header>
                      </div>
                    </div>
                  ...
                  <div class="section-image section-masthead__background section-masthead__background_halfscreen section-masthead__background_halfscreen-gutters mt-small mt-md-0">
                    <div class="section-image__wrapper js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                      <div class="js-transition-img__transformed-el">
                        <div class="lazy-bg" data-src="{{asset('public/assets1/img/assets/projects/logo.png')}}" style="width: 500px; height: 300px; margin-top:0px; margin-right:80px ;"></div>
                      </div>
                    </div>
                ...
                <section class="section section-content clearfix pt-medium text-center" data-arts-os-animation="data-arts-os-animation">
                  <div class="section-content__inner">
                    ...
                    <div class="section-content__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                      <h3>Hi, 850TH Group is always here to provide you the best business solutions. </h3>
                    </div>
                  </div>
                </section>
              </div>
          ...
          <section class="section section-services section-content mb-medium mt-medium" data-arts-os-animation="data-arts-os-animation">
            <div class="container-fluid no-gutters section-services__container">
                    ...
                    <div class="section-content__image-inner">
                      <section class="section section-image">
                        <div class="section-image__wrapper" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                          <div class="lazy"><img data-src="{{asset('public/assets1/img/assets/projects/p4.jpg')}}" src="#" alt width="1920" height="1280"></div>
                        </div>
                      </section>
                    </div>
                  </div>
                    ...
                    <section class="section section-content clearfix container-fluid pt-md-0 pb-md-0 pt-small" data-arts-os-animation="data-arts-os-animation">
                      <div class="section-content__inner">
                        ...
                        <div class="section-content__heading split-text js-split-text mb-0-5" data-split-text-type="lines,words" data-split-text-set="words">
                          <div class="small-caps">info@850TH.com</div>
                        </div>
                        <div class="w-100"></div>
                        <div class="section-content__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                          <h2>Subscription</h2>
                        ...
                        <p>850TH Group is a full service recruitment agency that offers a range of recruitment services to meet the specific needs of employers all over the world. Our strength is providing recruitment solutions within talent short emerging recruitment markets. </p>
                  

                         
                        </div>
                        <div class="w-100"></div>
                        <div class="section-content__button mt-2"><a class="d-inline-block no-highlight" href="marketing.php">
              ...
              <div class="section-services__wrapper-letter section-services__wrapper-letter_right">
                <div class="section-services__letter" data-arts-parallax="element" data-arts-parallax-y="-30%">M</div>
              </div>
            </div>
          </section>
          <!-- - section SERVICE # 1 -->
          ...
          <section class="section section-services section-content mb-medium mt-medium" data-arts-os-animation="data-arts-os-animation">
                ...
                <div class="col-lg-5 order-lg-2">
                  <div class="section-content__image overflow">
                    <div class="section-content__image-inner">
                      <section class="section section-image">
                        <div class="section-image__wrapper" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                          <div class="lazy"><img data-src="{{asset('public/assets1/img/assets/sectionServices/p7.jpg')}}" src="#" alt width="1280" height="1920"></div>
                        </div>
                      </section>
                    </div>
                  </div>
                  ...
                  <div class="section-services__wrapper-content">
                    <section class="section section-content clearfix container-fluid pt-md-0 pb-md-0 pt-small pl-md-0" data-arts-os-animation="data-arts-os-animation">
                      <div class="section-content__inner">
                        ...
                        <div class="w-100"></div>
                        <div class="section-content__button mt-2"><a class="d-inline-block no-highlight" href="finance.php">
                            <div class="arrow arrow-right js-arrow" data-arts-cursor="data-arts-cursor" data-arts-cursor-hide-native="true" data-arts-cursor-scale="0" data-arts-cursor-magnetic="data-arts-cursor-magnetic">
                              <svg class="svg-circle" viewBox="0 0 60 60" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <circle class="circle" cx="30" cy="30" r="29" fill="none"></circle>
                              </svg>
            ...
            <div class="section-services__wrapper-letter section-services__wrapper-letter_left">
              <div class="section-services__letter" data-arts-parallax="element" data-arts-parallax-y="-30%">F</div>
            </div>
          </section>
          <!-- - section SERVICE # 2 -->
          <!-- section SERVICE # 3 -->
                ...
                <div class="col-lg-5 order-lg-1">
                  <div class="section-content__image overflow">
                    <div class="section-content__image-inner">
                      <section class="section section-image">
                        <div class="section-image__wrapper" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                          <div class="lazy"><img data-src="{{asset('public/assets1/img/assets/sectionServices/p8.jpg')}}" src="#" alt width="1920" height="1920"></div>
                        </div>
                      </section>
                    </div>
                  </div>
                  ...
                  <div class="section-services__wrapper-content">
                    <section class="section section-content clearfix container-fluid pt-md-0 pb-md-0 pt-small pr-md-0" data-arts-os-animation="data-arts-os-animation">
                      <div class="section-content__inner">
                        ...
                        <div class="w-100"></div>
                        <div class="section-content__button mt-2"><a class="d-inline-block no-highlight" href="recruitment.php">
                            <div class="arrow arrow-right js-arrow" data-arts-cursor="data-arts-cursor" data-arts-cursor-hide-native="true" data-arts-cursor-scale="0" data-arts-cursor-magnetic="data-arts-cursor-magnetic">
                              <svg class="svg-circle" viewBox="0 0 60 60" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <circle class="circle" cx="30" cy="30" r="29" fill="none"></circle>
                              </svg>
                ...
                <div class="col-lg-7 order-lg-2">
                  <div class="section-content__image overflow">
                    <div class="section-content__image-inner">
                      <section class="section section-image">
                        <div class="section-image__wrapper" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                          <div class="lazy"><img data-src="{{asset('public/assets1/img/assets/sectionServices/project-10.jpg')}}" src="#" alt width="1920" height="1280"></div>
                        </div>
                      </section>
                    </div>
                  </div>
                  ...
                  <div class="section-services__wrapper-content">
                    <section class="section section-content clearfix container-fluid pt-md-0 pb-md-0 pt-small" data-arts-os-animation="data-arts-os-animation">
                      <div class="section-content__inner">
                        ...
                        <div class="w-100"></div>
                        <div class="section-content__text split-text js-split-text mt-1" data-split-text-type="lines" data-split-text-set="lines">
                          <p>850TH Group works with our investment teams to identify areas of risk or exposure our clients may face and help find ways to mitigate them. Our aim is to provide an integrated approach to risk identification and treatment, recognizing that insurance may be the most effective (but not necessarily the only) way of addressing these.</p>
                        </div>
                        <div class="w-100"></div>
                        <div class="section-content__button mt-2"><a class="d-inline-block no-highlight" href="">
                            <div class="arrow arrow-right js-arrow" data-arts-cursor="data-arts-cursor" data-arts-cursor-hide-native="true" data-arts-cursor-scale="0" data-arts-cursor-magnetic="data-arts-cursor-magnetic">
                              <svg class="svg-circle" viewBox="0 0 60 60" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <circle class="circle" cx="30" cy="30" r="29" fill="none"></circle>
                              </svg>
